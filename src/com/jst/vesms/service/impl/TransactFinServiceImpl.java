...
@Service("transactFinServiceImpl")
public class TransactFinServiceImpl extends BaseServiceImpl 
implements TransactFinService{
	...
	public BaseDAO getHibernateBaseDAO() {
		...
		return trancesactFinDao;
	}
	
	@Resource(name="callDao")
	private ICallDao callDao;

	@Resource(name="trancesactFinDao")
	private ITrancesactFinDao trancesactFinDao;

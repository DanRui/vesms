...
<!-- 		<div title="业务流水记录" class="datagrid-body">
	...
	<script type="text/javascript">
		$(function() {
			...
			// 审核保存提交审核操作，后台更新受理授权表
			$("#common-dialog-apply-special-check-submit").click(function() {
				...
				$.ajax({
	                //cache: true,
	                type : "POST",
	                url : basePath+"/applySpecialAuthority/check.do?ids="+checkIds,
	                data : {"checkType":checkType,"checkOpinion":checkOpinion},//审核操作，传入后台
	                async : true,

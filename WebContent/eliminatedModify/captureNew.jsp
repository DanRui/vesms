...
<body onload="Load()" onunload="Unload()" style="width: 700px;">
	...
	<c:if test="${fn:contains(param.modifyTypes, '31')}">
    ...
    <c:if test="${fn:contains(param.modifyTypes, '32')}">
    <tr class="datagrid-row">
    ...
    <c:if test="${fn:contains(param.modifyTypes, '34')}">
    <tr class="datagrid-row">
    ...
    <c:if test="${fn:contains(param.modifyTypes, '33')}">
    <tr class="datagrid-row">
    ...
    <c:if test="${fn:contains(param.modifyTypes, '37')}">
    <tr class="datagrid-row">
    ...
    <c:if test="${fn:contains(param.modifyTypes, '36')}">
    <tr class="datagrid-row">
    ...
    <c:if test="${fn:contains(param.modifyTypes, '38')}">
    <tr class="datagrid-row">
    ...
    <c:if test="${fn:contains(param.modifyTypes, '35')}">
    <tr class="datagrid-row">

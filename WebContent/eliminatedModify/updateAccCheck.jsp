...
<body>
	...
	<div id="update-check-account" class="easyui-accordion" data-options="fit:false" animate="false">
		<div title="车辆基本信息" class="datagrid-body"> 
			<div class="datagrid-header" style="overflow:hidden" > 			
				...
				<tr>
					...
					<!-- <td class="view_table_left"><font color="red">数据异常：</font></td>
					<td class="view_table_right">
						<font color="red">银行账户信息错误，车主银行卡号无效</font>
					</td> -->
				</tr>
		...
		<div title="补贴对象信息" class="datagrid-body">
			<div class="datagrid-header" style="overflow:hidden">
				<table class="datagrid-table-s datagrid-htable">											
						...
						<tr>
							<td class="view_table_left">修改后开户户名：</td>
							<td class="view_table_right">
								叶向东				
							</td>
							<td class="view_table_left">修改后开户银行：</td>
							<td class="view_table_right">
								招商银行
							</td>
							<td class="view_table_left">修改后开户银行账号：</td>
							<td class="view_table_right">
								<font color="red">425146123213456</font>
							</td>
						</tr>
						<tr>
			...
			<div class="datagrid-header" style="overflow:hidden">
				<table class="datagrid-table-s datagrid-htable">
					<tr class="datagrid-row">
						...
						<td class="view_table_right">
							<select name="checkType" class="easyui-combobox" data-options="editable:false,required:true,width:100,panelHeight:'auto'">   
    							<option>请选择</option>   
						...
						<!-- <td class="view_table_left">退回类型：</td>
						<td class="view_table_right">
							<input class="easyui-combobox" name="faultType" data-options="valueField:'id',textField:'text',url:'data/faultType.json',panelHeight:'auto'"/>  
						</td> -->
						<td class="view_table_left"><font color="red">数据异常：</font></td>
						<td class="view_table_right" colspan="3">
							<font color="red">银行账户信息错误，车主银行卡号无效,修改前账号433121345646123，修改后账号425146123213456</font>
					</td>
					</tr>
					<tr class="datagrid-row">
						<td class="view_table_left">审批意见：</td>
						<td class="view_table_right" colspan="3">
							<textarea name="checkOpinion" rows="3" style="width: 270px"/>
						</td>
					</tr>
				</table>
			</div>

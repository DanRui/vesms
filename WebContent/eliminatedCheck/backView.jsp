...
<body>
	 <div id="eliminated-check-back-view"  class="datagrid-header">
			<table class="datagrid-table-s datagrid-htable">
				...
				<td align="center" colspan="2" style="color:red">
					<a id="btnBackCheck" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-check-apply'">审核</a>
				</td>
			</tr>
			...
			<tr class="datagrid-row">
				...
				<td class="view_table_left" style="width: 110px">经办人身份证号：</td>
				<td class="view_table_right">
					${v.agentIdentity}
				</td>
			</tr>

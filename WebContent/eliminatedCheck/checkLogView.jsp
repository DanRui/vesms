...
<body>
	...
	<div id="eliminated-check-log-view" class="easyui-accordion" data-options="fit:true" animate="false">
			...
			<div class="datagrid-header" style="overflow:hidden" > 			
				...
				<tr class="datagrid-row">
					...
					<td class="view_table_right" colspan="5">
						<c:if test="${param.isPersonal eq 'Y'}">
							自然人
						</c:if>				

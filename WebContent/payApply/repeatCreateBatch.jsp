...
<body>
	<div id = "repeatBatchCreate-list" class="easyui-panel  easyui-panel-style" data-options="title: '查询列表'" style="height:100%">
	...
	$(function(){
		...
		/*	onDblClickRow : function(rowIndex, rowData) {
				$(this).datagrid("view",{width:800,height:450,url:basePath+"/payApply/view.do?id="+rowData.id+"&type=view",content:"重报批次受理单明细"});
			}*/
		}).datagrid("initSearch",{
			columns:[
